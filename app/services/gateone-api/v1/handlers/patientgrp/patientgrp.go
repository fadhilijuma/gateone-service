// Package patientgrp Package productgrp maintains the group of handlers for product access.
package patientgrp
...
func (h *handlers) update(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
	...
	patient := mid.GetPatient(ctx)

	updPn, err := h.patient.Update(ctx, patient, toCoreUpdatePatient(app))
	if err != nil {
